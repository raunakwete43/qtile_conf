...
def everforest():
    colors = [
        ["#2B3339", "#2B3339"],  # background (dark grey) [0]
...
def nord():
    colors = [
        ["#2e3440", "#2e3440"],  # background (dark grey) [0]
...
def gruvbox_light():
    colors = [
        ["#fbf1c7", "#fbf1c7"],  # background (dark grey) [0]
...
def moonfly():
    colors = [
        ["#323437", "#323437"],  # background (dark grey) [0]
